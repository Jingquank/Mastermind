...
const THEMES = {
  ...
  nacht: {
    // id stays `nacht` (saved configs reference it); displays as "Mint".
    mode: 'dark',
    gray: { 1: '#282a36', 2: '#343746', 6: '#44475a', 10: '#6272a4', 11: '#9aa3c4', 12: '#f8f8f2' },
    accent: '#50fa7b',
    dim: '#2fce5d',
    lit: {
    ...
    scheme: 'dark',
    note: 'Mint (dark, spring green — Dracula-based).',
  },
  sepia: {
    mode: 'light',
  ...
  cobalt: {
    ...
    scheme: 'light',
    note: 'Cobalt (light, electric blue).',
  },
  rose: {
    mode: 'light',
    gray: { 1: '#fcfcfa', 2: '#f2f2ef', 6: '#e2e1db', 10: '#9a968c', 11: '#66665f', 12: '#141414' },
    ...
    scheme: 'light',
    note: 'Rose (warm light, muted magenta).',
  },
  slate: {
    mode: 'dark',
    ...
    scheme: 'dark',
    note: 'Slate (cool dark, soft teal).',
  },
  carbon: {
    mode: 'dark',
    gray: { 1: '#08090a', 2: '#121316', 6: '#26282c', 10: '#5f6266', 11: '#9a9ca0', 12: '#f0f1f2' },
    accent: '#7c93b0',
    dim: '#a3b6d0',
    lit: {
    ...
    scheme: 'dark',
    note: 'Carbon (near-black, steel blue-gray).',
  },
}
...
console.log('\nwrote themes/{grid,nacht,sepia,cobalt,rose,slate,carbon}/tokens.css')
