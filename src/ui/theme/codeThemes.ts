 ...
 *
 * `tokenize()` (src/shared/highlight.ts) emits exactly these seven colorable
 * token types; `text` falls through to the base `--color-text`.
 */

import type { HlToken } from '../../shared/highlight'
